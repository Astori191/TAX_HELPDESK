        ...
        <div class="row mt-3">
          <div class="col">
            ...
            <div class="row">
              <div class="d-flex p-3 align-items-center">
                <div class="d-flex me-3 justify-content-center right-section">
                  <a href="news-view_all.php"><span class="icon icon-news" style="width: 70px; height: 70px;"></span></a>
                </div>
                <a href="news-view_all.php" class="text-decoration-none ps-3 sections-hover">
                  <div class="item-text">Все новости</div>
                </a>
              </div>
            </div>
          </div>
