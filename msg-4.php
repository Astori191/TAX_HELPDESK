                    ...
                    <div class="popup">
                        ...
                        <div class="row mt-4 ps-2 pe-2">
                            <div class="alert alert-warning fs-6" role="alert">
                                <p class="mt-3">Вы не внесли никаких изменений в учетные данные пользователя.</p>
                                <span>Вы автоматически вернётесь к выбору другого пользователя через 10 секунд.</span>
...
<script>
    var myAddress = 'change_user_info.php'; // адрес страницы, на которую нужно перейти
    var myTime = 10000; // время в минутах, через которое надо перейти на другую страницу
